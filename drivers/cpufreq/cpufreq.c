...
{
	int ret = sscanf( buf, "%i %i %i %i %i %i %i",&FakeShmoo_UV_mV_Ptr[6], &FakeShmoo_UV_mV_Ptr[5], 
								&FakeShmoo_UV_mV_Ptr[4], &FakeShmoo_UV_mV_Ptr[3], 
								&FakeShmoo_UV_mV_Ptr[2], &FakeShmoo_UV_mV_Ptr[1], 
